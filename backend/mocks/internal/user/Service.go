...
func (_m *Service) Find(id entity.ID) (entity.User, error) {
	ret := _m.Called(id)
...
func (_m *Service) FindAll() ([]entity.User, error) {
	ret := _m.Called()
...
func (_m *Service) Login(email string, password string) (entity.User, error) {
...
func (_m *Service) Store(_a0 *entity.User) (entity.ID, error) {
	ret := _m.Called(_a0)
...
func (_m *Service) Update(_a0 *entity.User) error {
	ret := _m.Called(_a0)
