...
func (_m *Repository) Find(id entity.ID) (entity.Account, error) {
	ret := _m.Called(id)
...
func (_m *Repository) FindAll() ([]entity.Account, error) {
	ret := _m.Called()
...
func (_m *Repository) Store(_a0 *entity.Account) (entity.ID, error) {
	ret := _m.Called(_a0)
...
func (_m *Repository) Update(_a0 *entity.Account) error {
	ret := _m.Called(_a0)
